<%@ Page Language="C#" AutoEventWireup="true" CodeFile="QuestionType.aspx.cs" Inherits="manager_QuestionType" %>
...
<head id="Head1" runat="server">
    ...
    function Winopen()
    {
        window.open("EditQuestionType.aspx?flag=0","new","");
    }
    </script>
                    ...
                    <table border="1" bordercolor="#1c5e55" style="border-collapse: collapse; width: 744px;
                        ...
                        <tr>
                            <td colspan="4" style="height: 24px" background="images/bg2.gif">
                                <span style="font-size: 12pt; font-family: 楷体_GB2312">试题类型管理</span> &nbsp;&nbsp;</td>
                        </tr>
                        <tr>
                                ...
                                <table align="center" border="1" bordercolor="#1c5e55" style="border-collapse: collapse;">
                                    <tr>
                                        <td align="center" valign="top" style="height: 119px">
                                            单击试题类型编号执行相应的更新操作&nbsp;<br />
                                            <asp:GridView ID="GridView1" runat="server" Width="700px" AutoGenerateColumns="False"
                                               AllowPaging="True" DataKeyNames="testid"  CellPadding="4" ForeColor="#333333" GridLines="None" OnSelectedIndexChanged="GridView1_SelectedIndexChanged1">
                                                <Columns>
                                                <asp:HyperLinkField DataTextField="testid" DataTextFormatString="{0}" DataNavigateUrlFields="testid"
                                                        DataNavigateUrlFormatString="EditQuestionType.aspx?flag=1&amp;testid={0}" HeaderText="试题类型编号"
                                                        Target="_blank" />
                                                    <asp:BoundField DataField="type" HeaderText="试题类型名称" SortExpression="type" />
                                    ...
                                    <tr>
                                        <td align="right" style="height: 25px">
                                            <asp:Label ID="lblPageCount" runat="server"></asp:Label><asp:Label ID="lblCurrentIndex" runat="server"></asp:Label>
